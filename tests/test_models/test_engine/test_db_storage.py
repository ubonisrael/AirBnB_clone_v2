#!/usr/bin/python3
"""Defines unittests for db storage"""
import MySQLdb
import unittest
...
@unittest.skipIf(environ.get('HBNB_TYPE_STORAGE') != 'db', "not supported in this storage engine")
class TestDBStorage(unittest.TestCase):
    ...
    def test_delete(self):
        ...
        self.assertNotIn(st, list(self.storage.all()))
